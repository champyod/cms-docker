...
const TABLE: &[DispatchEntry] = &[
    ...
    DispatchEntry::script(DispatchKey::WorkerEdit, "__tui/runners/__fleet-actions.sh"),
    ...
    DispatchEntry::script(DispatchKey::WorkerServer, "__tui/wizards/__server.sh"),
    ...
    DispatchEntry::script(DispatchKey::Expose, "__tui/wizards/__expose.sh"),
