...
if [ "$STRATEGY_CHOICE" = "1" ]; then
    ...
    DEPLOY_TYPE="src"
    print_info "Using Local Source Build."
fi
...
CONTESTS_DEPLOY_CONFIG=[{"id":1,"port":8888,"domain":"contest.cms.local"}]
...
print_info "Waiting for database to be healthy (this may take 20-30s)..."
...
make cms-init
make prisma-sync
print_success "Database initialized and schema patched."
